...
const ScChoice = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'cb8035736b68063074be3a9f1dff7d1f0f57a170', tabindex: "0", onFocus: () => this.input.focus() }, index.h("div", { key: '1d7f9e63cf222c4a5737611f64d5dfa79df77802', part: "base", class: {
                'choice': true,
            ...
            }, onKeyDown: e => this.handleKeyDown(e), onMouseDown: e => this.handleMouseDown(e) }, index.h("slot", { key: 'c58cc31dd3b88e2e825af216eee1f16dd04e399f', name: "header" }), index.h("label", { key: '7afa3cd915329eb2e0881a18af5705030028f693', class: "choice__content", part: "content", htmlFor: this.inputId }, index.h("span", { key: '192ce4cec5db1fb081e3634aa4e6258ce0b7b649', part: "control", class: {
                choice__control: true,
                choice__checkbox: this.type === 'checkbox',
                choice__radio: this.type === 'radio',
            }, hidden: !this.showControl }, index.h("span", { key: '3eec35d0515eb681cc6abbc0afd8e7fb3e24e55b', part: "checked-icon", class: "choice__icon" }, this.type === 'checkbox' ? (index.h("svg", { viewBox: "0 0 16 16" }, index.h("g", { stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd", "stroke-linecap": "round" }, index.h("g", { stroke: "currentColor", "stroke-width": "2" }, index.h("g", { transform: "translate(3.428571, 3.428571)" }, index.h("path", { d: "M0,5.71428571 L3.42857143,9.14285714" }), index.h("path", { d: "M9.14285714,0 L3.42857143,9.14285714" })))))) : (index.h("svg", { viewBox: "0 0 16 16" }, index.h("g", { stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd" }, index.h("g", { fill: "currentColor" }, index.h("circle", { cx: "8", cy: "8", r: "3.42857143" })))))), index.h("input", { key: '8cb9d6a93b732cd55a0bac5caa6bdc53afa4ddd3', id: this.inputId, ref: el => (this.input = el), type: this.type, name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, "aria-checked": this.checked ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', "aria-labelledby": this.labelId, tabindex: "0",
            // required={this.required}
            onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus(), onChange: () => this.handleClickEvent() })), index.h("span", { key: 'f7c616d1881f8a586ad47ed801c58250f35b7b4f', part: "label", id: this.labelId, class: "choice__label" }, index.h("span", { key: '4dabb4ab0552c20c1bdafffeb13909f08464428d', class: "choice__label-text", hidden: !this.showLabel }, index.h("span", { key: '01a3011aaa8167c2f2a27d8e1a2c9b4749143a72', class: "choice__title", part: "title" }, index.h("slot", { key: 'a4d8823eb0733d05e79f71f8225e5bbee1dca214', onSlotchange: () => this.handleSlotChange() })), index.h("span", { key: '6bf6788400ec7c7fb39b08e8553d2009ec10338a', class: "choice__description description", part: "description", hidden: !this.hasDescription }, index.h("slot", { key: '5c5dfbfb0baaf8ae94433ebb8690d0075d7acffd', name: "description", onSlotchange: () => this.handleSlotChange() }))), index.h("span", { key: 'ffcc5b95d98a0efdd6fdd7e207119dcea9da8f13', class: "choice__price", hidden: !this.showPrice || (!this.hasPrice && !this.hasPer) }, index.h("span", { key: '6c3cd065831c6d3f1ac8fd966a9f974258639a3b', class: "choice__title" }, index.h("slot", { key: 'ae08b510d575581cb8eddbb3b59504e7f0863814', name: "price", onSlotchange: () => this.handleSlotChange() })), ' ', index.h("span", { key: 'c10435a2b309f259f032dac99d35f2562d118000', class: "choice__description" }, index.h("slot", { key: '8fb8ecf8c1a04f9d399971a6a3916155e2dbd6f0', name: "per", onSlotchange: () => this.handleSlotChange() }))))), index.h("slot", { key: 'afc6562d9a2867ee0b78ae36e6493b07b02debb4', name: "footer" }))));
    }
