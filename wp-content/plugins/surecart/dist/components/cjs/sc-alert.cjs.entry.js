...
const ScAlert = class {
    ...
    render() {
        return (index.h(index.Host, { key: '609f28d4455fa9bddada9d9742546c1983331d70', style: { 'scroll-margin-top': this.scrollMargin } }, index.h("div", { key: 'e840084e4387ec18665d5814cc155f6c3e0201dd', class: {
                'alert': true,
            ...
            }, part: "base", role: "alert", "aria-live": "assertive", "aria-atomic": "true", "aria-hidden": this.open ? 'false' : 'true', hidden: this.open ? false : true, onMouseMove: () => this.handleMouseMove() }, index.h("div", { key: '41b628c4df2e4f27c86f63f6098869785a441302', class: "alert__icon", part: "icon" }, index.h("slot", { key: '55687153fe075ae16cfa0501a0420f1b3e57aaea', name: "icon" }, this.icon())), index.h("div", { key: 'd80e73338a67ca5e462788386da65d0508b6df6b', class: "alert__text", part: "text" }, index.h("div", { key: '62bfac21060d3b219800636c0b9f0994503f5a83', class: "alert__title", part: "title" }, index.h("slot", { key: 'd022d880615602dc0d953fa508adde0a55c92369', name: "title" }, this.title)), index.h("div", { key: 'cee52def226d07812fd46ad3ed6c0812c730b016', class: "alert__message", part: "message" }, index.h("slot", { key: '5460cc11c0ab3561635c7a483d18c826199d611b' }))), this.closable && (index.h("span", { key: '50cfa594f4b866acf8d9f6d51fb2cae48c22e294', part: "close", class: "alert__close", onClick: () => this.handleCloseClick() }, index.h("span", { key: '780c992bccf7a0244ff666229e7616e4d2b5d6f0', class: "sr-only" }, "Dismiss"), index.h("svg", { key: 'c1f1b083fb0be838e8907de5e32747e5c16e8a24', class: "h-5 w-5", "x-description": "Heroicon name: solid/x", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 20 20", fill: "currentColor", "aria-hidden": "true" }, index.h("path", { key: '5a8fb943dc3bbe38031e212f765e85dfb02a5d6c', "fill-rule": "evenodd", d: "M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z", "clip-rule": "evenodd" })))))));
    }
