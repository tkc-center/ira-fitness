...
const ScBreadcrumb = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '66825739da5358c619e025859d18198ac45698ca', part: "base", class: {
                'breadcrumb-item': true,
                'breadcrumb-item--has-prefix': this.hasPrefix,
                'breadcrumb-item--has-suffix': this.hasSuffix,
            } }, index.h("span", { key: '304c12c2b7717fc71de73cfdb4d2898c0b8048f6', part: "prefix", class: "breadcrumb-item__prefix" }, index.h("slot", { key: 'e659e6a691db6a0fbd010b8e2646bf6880ef92fc', name: "prefix" })), index.h(Tag, { key: '1d47827abe1bdad7da3360c41b91ad37f5dadebe', part: "label", class: "breadcrumb-item__label breadcrumb-item__label--link", href: this.href, target: this.target, rel: this.rel }, index.h("slot", { key: '25b0a35b0d086ed743c44e2819c9cf8caee9d10a' })), index.h("span", { key: '6d1565bb00485e87f83145eef4bcf211770e3170', part: "suffix", class: "breadcrumb-item__suffix" }, index.h("slot", { key: '980c9d854b1d98b9e8d29e808d66cd6c9c275e01', name: "suffix", onSlotchange: () => this.handleSlotChange() })), index.h("span", { key: '9810502d3285dba3def2fda6d30f5a5168be856c', part: "separator", class: "breadcrumb-item__separator", "aria-hidden": "true" }, index.h("slot", { key: '0dbf3a5aa5048fc83f3c136436ca4525a7a95394', name: "separator", onSlotchange: () => this.handleSlotChange() }, index.h("sc-icon", { key: '8be971ab5b81dbb29bfa6d2a755fd4367d6b5af2', name: "chevron-right" })))));
    }
