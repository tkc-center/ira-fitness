...
const ScMenuLabel = class {
    ...
    render() {
        return (index.h("div", { key: '1923ab1437b29066927a688ef8ea35ea5f505e94', part: "base", class: "menu-label" }, index.h("slot", { key: 'e028439db781c07c3b8be13dd0ce3a76f7ca470e' })));
    }
};
...
const ScSelectDropdown = class {
    ...
    render() {
        var _a;
        return (index.h("div", { key: '38f6aeb34ccf74f820f6326b5c88d2a23b9de055', part: "base", class: {
                'select': true,
            ...
            } }, index.h("sc-form-control", { key: '284c6306e5159bd903a6d52c3681cd6ffc45f0e6', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("input", { key: '2cc846aa485b25761c57fe816ad5ca5a52efd01b', class: "select__hidden-input", name: this.name, ref: el => (this.input = el), value: this.value, required: this.required, disabled: this.disabled, autocomplete: this.autocomplete, tabindex: "-1", "aria-label": this.displayValue() || this.label || this.placeholder, onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus(), onChange: () => this.handleInputChange() }), index.h("sc-dropdown", { key: 'ed8d5c143d6dd8a92efb4c95f060926b86a59f83', exportparts: "trigger, panel", disabled: this.disabled, open: this.open, closeOnSelect: this.closeOnSelect, position: this.position, placement: this.placement, hoist: this.hoist, style: { '--panel-width': '100%' }, onScShow: () => this.handleShow(), onScHide: () => this.handleHide(), role: "select", "aria-open": this.open ? 'true' : 'false' }, index.h("slot", { key: '4171146679f151651d213bed7a1e8c1caad08c91', name: "trigger", slot: "trigger" }, index.h("div", { key: '44203dc55918add225d0af7a0954161db4bf7461', class: "trigger", role: "button", tabIndex: -1, onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }, index.h("div", { key: 'f45f195ad16cd23e6eb2f7bc5c8d0975619e7fcc', class: "select__value" }, index.h("slot", { key: '633094fc163de5579a0a398860f56933f4012046' }, this.displayValue() || this.placeholder || wp.i18n.__('Select...', 'surecart'))), index.h("sc-icon", { key: '1c04e9211cedd03140c13fdcb53a96daccf81439', exportparts: "base:caret", class: "select__caret", name: "chevron-down" }))), this.search && (index.h("sc-input", { key: '3bebc2438ea17ce529f5f6dc02f7ec7ce6e6aee9', exportparts: "base:search__base, input:search__input, form-control:search__form-control", placeholder: this.searchPlaceholder || wp.i18n.__('Search...', 'surecart'), onScInput: e => this.handleQuery(e), class: "search", clearable: true, part: "search", value: this.searchTerm, ref: el => (this.searchInput = el), "aria-label": wp.i18n.__('Type to search', 'surecart') }, this.loading && index.h("sc-spinner", { key: '3e84ddb8ede728d6d4ae70f9908f4e4c29e284ee', exportparts: "base:spinner__base", style: { '--spinner-size': '0.5em' }, slot: "suffix" }))), index.h("sc-menu", { key: '248ac3aa7b9c60ba1612e15d4b20049e537f4f5f', style: { maxHeight: this.open ? '210px' : '0px', overflow: 'auto' }, exportparts: "base:menu__base", onScroll: e => this.handleMenuScroll(e), "aria-multiselectable": "false" }, index.h("slot", { key: 'e3a5bf72ce23ac158e96c76a93dcea5f4a2053b2', name: "prefix" }), (this.filteredChoices || []).map((choice, index) => {
            return [this.renderItem(choice, index), (choice.choices || []).map(choice => this.renderItem(choice, index))];
        }), this.loading && (index.h("div", { key: 'c20d3babe8242f4f7cdf0ec17a35dad25cba76b1', class: "loading" }, index.h("sc-spinner", { key: '7e86e609d4b65f2b6a1caa4a814cca7b4ec02671', exportparts: "base:spinner__base" }))), !this.loading && !this.filteredChoices.length && (index.h("div", { key: '29d43db7a00d723c6187a3674ceb5fdf7cff93dd', class: "select__empty", part: "empty" }, wp.i18n.__('Nothing Found', 'surecart'))), index.h("slot", { key: 'eab8e479622a6d936edcde42d37612a2eeee253f', name: "suffix" }))))));
    }
