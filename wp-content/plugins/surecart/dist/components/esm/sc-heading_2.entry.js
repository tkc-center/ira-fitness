...
const ScHeading = class {
    ...
    render() {
        return (h("div", { key: '7c2ff5c6a7cdb0fe1998e6fa589376fb76229955', part: "base", class: {
                'heading': true,
                'heading--small': this.size === 'small',
                'heading--medium': this.size === 'medium',
                'heading--large': this.size === 'large',
            } }, h("div", { key: '28e31972d690df2e1d7d879545a85d963a020bee', class: { heading__text: true } }, h("div", { key: '1b034553bca5061e25d1fc72d0a052c42d9e2db2', class: "heading__title", part: "title" }, h("slot", { key: 'b23ded6f5fc98dffe134c5abb3397f627120a651' })), h("div", { key: '4d72d87b4b935b239e3276d1008dedd0f4f5ee5a', class: "heading__description", part: "description" }, h("slot", { key: '8016f3fd1f724dfb0fe2d66c43b9ce2225ed571f', name: "description" }))), h("slot", { key: '09d687939f3be0017df5d5510b3c40720a85316b', name: "end" })));
    }
