...
const ScFeatureDemoBanner = class {
    ...
    render() {
        return (h("div", { key: 'f31186768239c19cbaa177b4d1edaada77997edd', class: { 'sc-banner': true } }, h("p", { key: 'e3ef2099105a973cab6e160ec6c70cdf5274b623' }, h("slot", { key: 'f8d6659b8ad5104423bebcc46c0a5b58b0971732' }, wp.i18n.__('This is a feature demo. In order to use it, you must upgrade your plan.', 'surecart')), h("a", { key: '65ddd147c489bdf7ca279d707f62ff56aaaf33a0', href: this.url, target: "_blank" }, h("slot", { key: 'be953088ddc7da60acfaf8d3be03f3b1d8086675', name: "link" }, this.buttonText, " ", h("sc-icon", { key: '82ab8137aa51e28c460f63baac0df150732cf9f4', name: "arrow-right" }))))));
    }
};
