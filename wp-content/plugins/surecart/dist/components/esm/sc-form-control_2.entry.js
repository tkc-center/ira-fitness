...
const ScFormControl = class {
    ...
    render() {
        return (h("div", { key: 'cdc808d857734a2466a835539e63a9ddc8beccd2', part: "form-control", class: {
                'form-control': true,
            ...
            } }, h("label", { key: '0482bdcb5906d8c58d45ffec728f87e3ab972de7', part: "label", id: this.labelId, class: "form-control__label", htmlFor: this.inputId, "aria-hidden": !!this.label ? 'false' : 'true' }, h("slot", { key: 'bbba092126b95d34a79d67c8e145ab1ebad4eb22', name: "label" }, this.label), h("slot", { key: '34a1ce5a91fedb6f247861a711f2ad420e664e7c', name: "label-end" }), !!this.required && (h("span", { key: 'aec4775ae4e264ae79c1b2fbd8ba4d3591b48ab1', "aria-hidden": "true", class: "required" }, ' ', "*")), h("sc-visually-hidden", { key: '435b9fb16aa5ef979238a40fbd6be56b53c78e55' }, !!this.required ? wp.i18n.__('required', 'surecart') : '')), h("div", { key: 'c4a0f41aad49fbd96c13b7559ec00c92dd976c00', part: "input", class: "form-control__input" }, h("slot", { key: '9dd5dd81926af7afd6d719fd9eaa58b9dd6326e0' })), this.help && (h("div", { key: '37c67f2aab015951aa15be0b40adeafa0d39f731', part: "help-text", id: this.helpId, class: "form-control__help-text" }, h("slot", { key: 'b037cb074ee3c21be61f9e03d30aa03cc9c6f8fe', name: "help-text" }, this.help)))));
    }
...
const ScInput = class {
    ...
    render() {
        var _a;
        return (h(Host, { key: 'a81c272fa60732b9238fa71b92cd0795d7ef3e88', hidden: this.hidden }, h("sc-form-control", { key: 'a526f7eafc4f46c9ece412d4e5788bbd2b852e39', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, h("slot", { key: 'c95a8b9da4a9ae8da15153b9b4c61e6930009dd3', name: "label-end", slot: "label-end" }), h("div", { key: '8bc33479e4f906cfbde96cf2850005cc7b2b0553', part: "base", class: {
                'input': true,
                // Sizes
            ...
            } }, h("span", { key: '8539bbbd0fa63aedb6be5c650b41525bd8f455c7', part: "prefix", class: "input__prefix" }, h("slot", { key: '827efcddbc36e8187ed900423c5c9f64e92ae39c', name: "prefix" })), h("slot", { key: 'b386a4a398989b8d2425acfb7fc76e91c84575a6' }, h("input", { key: 'ff0ab090cca8388e1c555fbe6c658c8537146228', part: "input", id: this.inputId, class: "input__control", ref: el => (this.input = el), type: this.type === 'password' && this.isPasswordVisible ? 'text' : this.type, name: this.name, disabled: this.disabled, readonly: this.readonly, required: this.required, placeholder: this.placeholder, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step,
            ...
            } })), h("span", { key: 'b2648b271b2bbd1af9fd2deebbe54d7ea9be42d6', part: "suffix", class: "input__suffix" }, h("slot", { key: 'ab1b2c883ad533b44e6ec88db36b878d53dd6818', name: "suffix" })), this.clearable && ((_a = this.value) === null || _a === void 0 ? void 0 : _a.length) > 0 && (h("button", { key: '2a31a2a16f843b7110b856818a41a7352b19b783', part: "clear-button", class: "input__clear", type: "button", onClick: e => this.handleClearClick(e), tabindex: "-1" }, h("slot", { key: 'f7069d89cf7c063eb4be88dcadd94dfa1e7e280e', name: "clear-icon" }, h("svg", { key: 'f614867234505e657eba493612819cfdbedfc302', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "feather feather-x" }, h("line", { key: '85125b0c527be47aecb2aeb96ab804fb00ee37c8', x1: "18", y1: "6", x2: "6", y2: "18" }), h("line", { key: 'a1a83ae2eb8013ab36b85fbc0aec1bddd2a313f4', x1: "6", y1: "6", x2: "18", y2: "18" })))))))));
    }
    get el() { return getElement(this); }
