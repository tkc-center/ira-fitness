...
const ScBlockUi = class {
    ...
    render() {
        return (h("div", { key: '91d9f75db99f5079999fb0b981c32403d9661d3a', part: "base", class: { overlay: true, transparent: this.transparent }, style: { 'z-index': this.zIndex.toString() } }, h("div", { key: '1790ea72e630d30c5ebcfb77736d7c2e744fdd0e', class: "overlay__content", part: "content" }, h("slot", { key: 'e62393831082c1c7dbcba3107ce49f49d239c93a', name: "spinner" }, !this.transparent && this.spinner && h("sc-spinner", { key: '4d0a1d49f3cefbdb1417e3b22c374c90ea8c46df' })), h("slot", { key: '2ff76f1ef358e6357d4b163d636e6bba2d69a2c4' }))));
    }
};
